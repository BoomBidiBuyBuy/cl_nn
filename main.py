...
start = datetime.datetime.now()
vocab, vocab_size, check = data_helpers.create_vocab_set()
print('Vocab takes: ', datetime.datetime.now() - start)

start = datetime.datetime.now()
test_data = data_helpers.encode_data(x_test, maxlen, vocab, vocab_size, check)
print('Encoding test takes: ', datetime.datetime.now() - start)
...
print('Building model takes: ', datetime.datetime.now() - start)
...
for e in xrange(nb_epoch):
    ...
    print('Shuffling data takes: ', datetime.datetime.now() - start)
